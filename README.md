...
<li>Download this repository to your system.</li>
  ...
  <li>If you want to run the script without <code>*.sh</code> or <code>./</code> or <code>bash</code> commands, move it to one of the above folders and remove the <code>.sh</code> from the filename.
<li>
